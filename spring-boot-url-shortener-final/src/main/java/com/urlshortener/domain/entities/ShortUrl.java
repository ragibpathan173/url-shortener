package com.urlshortener.domain.entities;
...
public class ShortUrl {
    ...
    public com.urlshortener.domain.entities.User getCreatedBy() {
        return createdBy;
    }

    public void setCreatedBy(com.urlshortener.domain.entities.User createdBy) {
